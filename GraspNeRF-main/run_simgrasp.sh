...
GPUID=0
BLENDER_BIN=/home/lthpc/local/yuhang/blender-2.93.3-linux-x64/blender
...
while (( $mycount < $NUM_TRIALS )); do
   ...
   /home/lthpc/local/yuhang/blender-2.93.3-linux-x64/2.93/python/bin/python3.9 ./scripts/stat_expresult.py -- $SIM_LOG_DIR $expname
((mycount=$mycount+1));
done;
