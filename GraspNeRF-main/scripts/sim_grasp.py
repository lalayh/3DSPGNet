...
def main(args, round_idx, gpuid, render_frame_list):
    ...
    if args.method == "graspnerf":
        ...
        grasp_planner = SPG(args.model_path,
                            config,
                            best=True,
                            qual_th=0.9,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", type=str, default="config_spgrasp.yml")
    parser.add_argument("--model-path", type=Path, default="src/spgrasp/ckpt/spg_packed.ckpt")
