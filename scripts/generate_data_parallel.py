...
def main(args):
    ...
    for _ in range(grasps_per_worker // GRASPS_PER_SCENE):
        ...
        rgb_imgs_side, depth_imgs_side, extrinsics_side = render_side_images(sim, 1, args.random)
    ...
    pbar.close()
    print('Process %d finished!' % args.terminal_num)
...
def render_images(sim, n):
    ...
    rgb_imgs = np.empty((n, height, width, 3), np.float32)
