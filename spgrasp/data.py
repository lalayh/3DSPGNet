...
class Dataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, ind):
        ...
        inds_04_index_label = np.argwhere(index_label == 1) 
        ...
        tsdf_04_label_label = spconv.SparseConvTensor( 
            ...
            spatial_shape_04, batch_size)
        tsdf_04_rotations_label = spconv.SparseConvTensor( 
            torch.from_numpy(tsdf_04_rotations_label),
            torch.cat([torch.zeros(inds_04_index_label.shape[0], 1), torch.from_numpy(inds_04_index_label)], dim=1).int(),
            spatial_shape_04, batch_size)
        tsdf_04_width_label = spconv.SparseConvTensor(
            torch.from_numpy(tsdf_04_width_label[:, None]),
            torch.cat([torch.zeros(inds_04_index_label.shape[0], 1), torch.from_numpy(inds_04_index_label)], dim=1).int(),
            spatial_shape_04, batch_size)
        tsdf_04_offset_label = spconv.SparseConvTensor(
        ...
        scene = {
            ...
            "voxel_gt_dense": tsdf_04, 
            "voxel_gt_label": tsdf_04_label_label, 
            "voxel_gt_rotations": tsdf_04_rotations_label,
            "voxel_gt_width": tsdf_04_width_label,
            "voxel_gt_offset": tsdf_04_offset_label, 
